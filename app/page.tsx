...
const mockOrders: Order[] = [
  {
    ...
    departments: [
      { 
        ...
        inProgress: false,
        employee: '张销售',
        startTime: '12/20 09:00',
        completedTime: '12/20 11:30',
        estimatedHours: 2,
        actualHours: 2.5,
        priority: 'high'
      },
      { 
        ...
        inProgress: false,
        employee: '王主管',
        startTime: '12/20 14:00',
        completedTime: '12/21 10:00',
        estimatedHours: 4,
        actualHours: 3,
        priority: 'medium'
      },
      { 
        ...
        inProgress: true, 
        hoursLate: 2, 
        note: 'Tool broken, waiting for replacement',
        employee: '刘程序员',
        startTime: '12/21 13:00',
        estimatedHours: 8,
        actualHours: 6,
        priority: 'high'
      },
      { name: '操机', completed: false, inProgress: false, estimatedHours: 6, priority: 'medium' },
      { name: '手工', completed: false, inProgress: false, estimatedHours: 4, priority: 'low' },
      { name: '表面处理', completed: false, inProgress: false, estimatedHours: 3, priority: 'medium' },
      { name: '检验', completed: false, inProgress: false, estimatedHours: 2, priority: 'high' },
      { name: '出货', completed: false, inProgress: false, estimatedHours: 1, priority: 'low' },
    ]
  },
  {
    id: '2',
    ...
    departments: [
      { 
        ...
        inProgress: false,
        employee: 'Sarah Chen',
        startTime: '12/19 08:00',
        completedTime: '12/19 10:00',
        estimatedHours: 2,
        actualHours: 2,
        priority: 'medium'
      },
      { 
        ...
        startTime: '12/19 11:00',
        completedTime: '12/19 15:00',
        estimatedHours: 3,
        actualHours: 4,
        priority: 'medium'
      },
      ...
      { 
        ...
        inProgress: false,
        employee: 'Tom Wilson',
        startTime: '12/22 08:00',
        completedTime: '12/22 16:00',
        estimatedHours: 8,
        actualHours: 8,
        priority: 'medium'
      },
      { 
        ...
        inProgress: false,
        employee: 'Lisa Zhang',
        startTime: '12/23 09:00',
        completedTime: '12/23 13:00',
        estimatedHours: 4,
        actualHours: 4,
        priority: 'low'
      },
      { 
        ...
        inProgress: false,
        employee: 'David Lee',
        startTime: '12/23 14:00',
        completedTime: '12/24 11:00',
        estimatedHours: 3,
        actualHours: 5,
        priority: 'medium'
      },
  ...
  },
  {
    ...
    departments: [
      { 
        ...
        inProgress: false,
        employee: '陈报价',
        startTime: '12/22 10:00',
        completedTime: '12/22 14:00',
        estimatedHours: 3,
        actualHours: 4,
        priority: 'low'
      },
      ...
      { name: '编程', completed: false, inProgress: false, estimatedHours: 6, priority: 'high' },
      { name: '操机', completed: false, inProgress: false, estimatedHours: 8, priority: 'medium' },
      { name: '手工', completed: false, inProgress: false, estimatedHours: 3, priority: 'low' },
      { name: '表面处理', completed: false, inProgress: false, estimatedHours: 4, priority: 'medium' },
      { name: '检验', completed: false, inProgress: false, estimatedHours: 2, priority: 'high' },
      { name: '出货', completed: false, inProgress: false, estimatedHours: 1, priority: 'low' },
    ]
  },
  {
    ...
    departments: [
      { 
        ...
        inProgress: false,
        employee: '李销售',
        startTime: '12/21 10:00',
        completedTime: '12/21 16:00',
        estimatedHours: 4,
        actualHours: 6,
        priority: 'medium'
      },
      { name: '生产审批', completed: true, inProgress: false, employee: '张主管', priority: 'low' },
      { name: '编程', completed: false, inProgress: false, estimatedHours: 5, priority: 'high' },
      { name: '操机', completed: false, inProgress: false, estimatedHours: 7, priority: 'medium' },
      { name: '手工', completed: false, inProgress: false, estimatedHours: 2, priority: 'low' },
      { name: '表面处理', completed: false, inProgress: false, estimatedHours: 3, priority: 'medium' },
      { name: '检验', completed: false, inProgress: false, estimatedHours: 2, priority: 'high' },
      { name: '出货', completed: false, inProgress: false, estimatedHours: 1, priority: 'low' },
    ]
...
function EmployeeInterface() {
  ...
  const tasks = generateEmployeeTasks(mockOrders, selectedDept);
  ...
  const handleFlag = (taskId: string) => {
    console.log('Flagging issue for task:', taskId);
  };
